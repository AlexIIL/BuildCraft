...
public final class StatementManager {
    ...
    /** Generally, this function should be called by every mod implementing the Statements API ***as a container***
     * (that is, adding its own gates) on the client side from a given Item of choice. */
