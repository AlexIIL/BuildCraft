        ...
        if (robot.getHeldItem() == null) {
            ...
            IBlockFilter blockFilter = new IBlockFilter() {
                ...
                public boolean matches(World world, int x, int y, int z) {
                    return !BuildCraftAPI.getWorldProperty("replaceable").get(world, x, y, z) && isPlantable(itemStack, world, x, y, z) && !robot
                            .getRegistry().isTaken(new ResourceIdBlock(x, y, z));
                }
            };
