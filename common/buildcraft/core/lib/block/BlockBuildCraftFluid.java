...
public class BlockBuildCraftFluid extends BlockFluidClassic {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        this.theIcon = new IIcon[] { iconRegister.registerIcon(prefix + fluidName + "_still"), iconRegister.registerIcon(prefix + fluidName
            + "_flow") };
    }
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        ...
        if (rand.nextInt(10) == 0 && World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !world.getBlock(x, y - 2, z).getMaterial()
                .blocksMovement()) {
