...
public class PathFindingSearch implements IIterableAlgorithm {
    ...
    public PathFindingSearch(World iWorld, BlockIndex iStart, Iterator<BlockIndex> iBlockIter, IBlockFilter iPathFound, double iMaxDistanceToEnd,
    ...
    private void iterateSearch(int itNumber) {
        for (int i = 0; i < itNumber; ++i) {
            ...
            BlockIndex block = new BlockIndex(start.x + delta.x, ((start.y + delta.y) > 0) ? start.y + delta.y : 0, start.z + delta.z);
