...
public abstract class EntityLaser extends Entity {
    ...
    public static final ResourceLocation[] LASER_TEXTURES = new ResourceLocation[] { new ResourceLocation("buildcraftcore",
            "textures/laserBeams/laser_1.png"), new ResourceLocation("buildcraftcore", "textures/laserBeams/laser_2.png"), new ResourceLocation(
                    "buildcraftcore", "textures/laserBeams/laser_3.png"), new ResourceLocation("buildcraftcore", "textures/laserBeams/laser_4.png"),
        new ResourceLocation("buildcraftcore", "textures/laserBeams/stripes.png"), new ResourceLocation("buildcraftcore",
                "textures/laserBeams/blue_stripes.png") };
