...
public class StatementParameterDirection implements IStatementParameter {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        icons = new IIcon[] { iconRegister.registerIcon("buildcraftcore:triggers/trigger_dir_down"), iconRegister.registerIcon(
                "buildcraftcore:triggers/trigger_dir_up"), iconRegister.registerIcon("buildcraftcore:triggers/trigger_dir_north"), iconRegister
                        .registerIcon("buildcraftcore:triggers/trigger_dir_south"), iconRegister.registerIcon(
                                "buildcraftcore:triggers/trigger_dir_west"), iconRegister.registerIcon("buildcraftcore:triggers/trigger_dir_east") };
    }
