...
public class Version implements Runnable {
    ...
    public static void displayChangelog(ICommandSender sender) {
        sender.addChatMessage(new ChatComponentTranslation("command.buildcraft.changelog_header", getRecommendedVersion()).setChatStyle(
                new ChatStyle().setColor(EnumChatFormatting.GRAY).setBold(true)));
