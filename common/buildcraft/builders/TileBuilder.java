...
public class TileBuilder extends TileAbstractBuilder implements IHasWork, IFluidHandler, IRequestProvider, IControllable {
        ...
        if (initNBT != null) {
            ...
            if (initNBT.hasKey("iterator")) {
                ...
                while (!done && currentBuilder != null && currentPathIterator != null) {
                    BlockIndex bi = new BlockIndex((int) currentPathIterator.ix, (int) currentPathIterator.iy, (int) currentPathIterator.iz);
    ...
    public void createLasersForPath() {
        ...
        for (BlockIndex b : path) {
            if (previous != null) {
                LaserData laser = new LaserData(new Position(previous.x + 0.5, previous.y + 0.5, previous.z + 0.5), new Position(b.x + 0.5, b.y + 0.5,
                        b.z + 0.5));
        ...
        if (currentBuilder == null || (currentBuilder.isDone(this) || forceIterate)) {
            if (path != null && path.size() > 1) {
                if (currentPathIterator == null) {
                    ...
                    currentPathIterator = new PathIterator(start, it, ForgeDirection.values()[worldObj.getBlockMetadata(xCoord, yCoord, zCoord)]
                            .getOpposite());
                }
                ...
                if (currentBuilder != null && currentBuilder.isDone(this)) {
                    ...
                    if (bpt != null) {
                        recursiveBuilder = new RecursiveBlueprintBuilder(bpt, worldObj, xCoord, yCoord, zCoord, ForgeDirection.values()[worldObj
    ...
    public void writeToNBT(NBTTagCompound nbttagcompound) {
        ...
        if (currentPathIterator != null) {
            ...
            new BlockIndex((int) currentPathIterator.ix, (int) currentPathIterator.iy, (int) currentPathIterator.iz).writeTo(iteratorNBT);
    ...
    public void updateEntity() {
        ...
        if (mode != Mode.Off) {
            if (getWorldObj().getWorldInfo().getGameType() == GameType.CREATIVE || getBattery().getEnergyStored() > POWER_ACTIVATION) {
                build();
            }
        }
