        ...
        if (done) {
            ...
            if (subTile instanceof TileArchitect) {
                ...
                if (subTile instanceof TileConstructionMarker) {
                    ...
                    orientation = ForgeDirection.values()[architect.getWorldObj().getBlockMetadata(subBlock.x, subBlock.y, subBlock.z)].getOpposite();
                }
            ...
            if (currentSubReader.isDone()) {
                writingBlueprint.addSubBlueprint(currentSubReader.getBlueprint(), currentSubReader.architect.xCoord - architect.getBox().xMin,
                        ...
                        ForgeDirection.values()[currentSubReader.architect.getWorldObj().getBlockMetadata(currentSubReader.architect.xCoord,
            ...
            if (blockScanner.blocksLeft() == 0) {
                ...
                ForgeDirection o = ForgeDirection.values()[architect.getWorldObj().getBlockMetadata(architect.xCoord, architect.yCoord,
                        architect.zCoord)].getOpposite();
