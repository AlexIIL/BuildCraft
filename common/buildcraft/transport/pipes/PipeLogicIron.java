...
public abstract class PipeLogicIron {
    ...
    public void switchOnRedstone() {
        boolean currentPower = pipe.container.getWorldObj().isBlockIndirectlyGettingPowered(pipe.container.xCoord, pipe.container.yCoord,
    ...
    public boolean setFacing(ForgeDirection facing) {
        if (facing.ordinal() != pipe.container.getBlockMetadata() && isValidFacing(facing)) {
            pipe.container.getWorldObj().setBlockMetadataWithNotify(pipe.container.xCoord, pipe.container.yCoord, pipe.container.zCoord, facing
                    .ordinal(), 3);
    ...
    public boolean blockActivated(EntityPlayer entityplayer, ForgeDirection side) {
        ...
        if (equipped instanceof IToolWrench && ((IToolWrench) equipped).canWrench(entityplayer, pipe.container.xCoord, pipe.container.yCoord,
                pipe.container.zCoord)) {
