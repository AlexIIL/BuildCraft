...
public class PipeItemsObsidian extends Pipe<PipeTransportItems> implements IEnergyHandler {
            ...
            if (distance == 1 && entity instanceof EntityMinecart && entity instanceof IInventory) {
                ...
                if (!cart.isDead) {
                    ...
                    if (stack != null && battery.useEnergy(10, 10, false) > 0) {
                        ...
                        if (stack != null) {
                            TravelingItem item = TravelingItem.make(container.xCoord + 0.5, container.yCoord + TransportUtils.getPipeFloorOf(stack),
    ...
    public void pullItemIntoPipe(Entity entity, int distance) {
        ...
        if (orientation != ForgeDirection.UNKNOWN) {
            container.getWorldObj().playSoundAtEntity(entity, "random.pop", 0.2F, ((container.getWorldObj().rand.nextFloat() - container
            ...
            TravelingItem item = TravelingItem.make(container.xCoord + 0.5, container.yCoord + TransportUtils.getPipeFloorOf(stack), container.zCoord
                + 0.5, stack);
