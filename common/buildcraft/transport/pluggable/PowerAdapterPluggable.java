...
public class PowerAdapterPluggable extends PipePluggable implements IEnergyHandler {
    ...
    protected static final class PowerAdapterPluggableRenderer implements IPipePluggableRenderer {
        ...
        public void renderPluggable(RenderBlocks renderblocks, IPipe pipe, ForgeDirection side, PipePluggable pipePluggable,
            ...
            for (int i = 0; i < 6; i++) {
                icons[i] = BuildCraftTransport.instance.pipeIconProvider.getIcon((i & 6) == (bottom & 6)
                    ? PipeIconProvider.TYPE.PipePowerAdapterBottom.ordinal() : PipeIconProvider.TYPE.PipePowerAdapterSide.ordinal());
            }
            ...
            icons[bottom] = icons[bottom ^ 1] = BuildCraftTransport.instance.pipeIconProvider.getIcon(PipeIconProvider.TYPE.PipePowerAdapterTop
                    .ordinal());
