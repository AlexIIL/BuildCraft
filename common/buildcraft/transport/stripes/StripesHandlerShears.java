...
public class StripesHandlerShears implements IStripesHandler {
    ...
    @Override
    public boolean handle(World world, int x, int y, int z, ForgeDirection direction, ItemStack stack, EntityPlayer player,
        ...
        if (block instanceof IShearable) {
            ...
            if (shearableBlock.isShearable(stack, world, x, y, z)) {
                ...
                List<ItemStack> drops = shearableBlock.onSheared(stack, world, x, y, z, EnchantmentHelper.getEnchantmentLevel(
