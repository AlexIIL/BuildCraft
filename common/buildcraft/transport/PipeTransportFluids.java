...
public class PipeTransportFluids extends PipeTransport implements IFluidHandler, IDebuggable {
    ...
    public void sendDescriptionPacket() {
        ...
        BuildCraftTransport.instance.sendToPlayers(update, container.getWorldObj(), container.xCoord, container.yCoord, container.zCoord,
                DefaultProps.PIPE_CONTENTS_RENDER_DIST);
    }
    ...
    public void getDebugInfo(List<String> info, ForgeDirection side, ItemStack debugger, EntityPlayer player) {
        ...
        info.add(String.format("PipeTransportFluids (%s, %d mB, %d mB/t)", fluidType != null ? fluidType.getLocalizedName() : "Empty", capacity,
                flowRate));
