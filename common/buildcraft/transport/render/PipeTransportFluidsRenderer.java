...
public class PipeTransportFluidsRenderer extends PipeTransportRenderer<PipeTransportFluids> {
    ...
    public void render(Pipe<PipeTransportFluids> pipe, double x, double y, double z, float f) {
        ...
        int skylight = pipe.container.getWorld().getSkyBlockTypeBrightness(EnumSkyBlock.Sky, pipe.container.x(), pipe.container.y(), pipe.container
                .z());
        int blocklight = pipe.container.getWorld().getSkyBlockTypeBrightness(EnumSkyBlock.Block, pipe.container.x(), pipe.container.y(),
                pipe.container.z());
