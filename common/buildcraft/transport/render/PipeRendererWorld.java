                ...
                if (Minecraft.getMinecraft().gameSettings.fancyGraphics) {
                    ...
                    if (!(block instanceof BlockGenericPipe) && !block.isOpaqueCube()) {
                        ...
                        if (block instanceof BlockChest) {
                            ...
                            blockBB = new double[] { block.getBlockBoundsMinY(), block.getBlockBoundsMinX(), block.getBlockBoundsMinZ(), block
                                    .getBlockBoundsMaxY(), block.getBlockBoundsMaxX(), block.getBlockBoundsMaxZ() };
                        }
