...
public class BlockLaser extends BlockBuildCraft implements ICustomHighlight {
    ...
    private static final AxisAlignedBB[][] boxes = { { AxisAlignedBB.getBoundingBox(0.0, 0.75, 0.0, 1.0, 1.0, 1.0), AxisAlignedBB.getBoundingBox(
            0.3125, 0.1875, 0.3125, 0.6875, 0.75, 0.6875) }, // -Y
